...
#
# Info:
# This script is meant to be called by other scripts. It is the job of the caller to
# check the return/exit value "$?" of this script. This script is not designed to
# provide human-readable errors.
# When called with the 'create' option you must provide the PID of the script that
# calls this one. It's usually going to be '$$'
#
...
# 7 --no longer used--
# 8 [BAD] The lock file ($2) exists and locker cannot write to it.
# 9 [BAD] unable to write to lock file.
#
NAME=$1
FILE=$2
ACTION=$3
